package com.playMatch.ui.home.dialogs.interestDialog
...
class InterestsDialog (private val activity: Activity) {
    fun interestDialog(buttonClickListener: ButtonClickListener) {
