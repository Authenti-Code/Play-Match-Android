package com.playMatch.ui.home.adapter.notificationAdapter
...
class NotificationAdapter(var list: ArrayList<HomeChildModel>, var activity: Activity) : RecyclerView.Adapter<NotificationAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: RvNotificationListItemBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = RvNotificationListItemBinding
