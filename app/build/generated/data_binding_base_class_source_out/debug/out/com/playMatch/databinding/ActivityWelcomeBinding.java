...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull LinearLayout rootView, @NonNull CardView getStarted) {
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.getStarted;
      CardView getStarted = ViewBindings.findChildViewById(rootView, id);
      if (getStarted == null) {
        break missingId;
      }

      return new ActivityWelcomeBinding((LinearLayout) rootView, getStarted);
    }
