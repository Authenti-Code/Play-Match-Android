...
public final class RvChildHomeListItemBinding implements ViewBinding {
  ...
  @NonNull
  public static RvChildHomeListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RvChildHomeListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rv_child_home_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RvChildHomeListItemBinding bind(@NonNull View rootView) {
