...
public final class RvListItemSelectTeamBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RvListItemSelectTeamBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RvListItemSelectTeamBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rv_list_item_select_team, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RvListItemSelectTeamBinding bind(@NonNull View rootView) {
